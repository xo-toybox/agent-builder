...
export function Sidebar({ isAuthenticated, userEmail, onLogin, onLogout }: SidebarProps) {
  return (
    <div className="w-52 bg-bg-secondary border-r border-border flex flex-col">
      ...
      <nav className="flex-1 p-2">
        <div className="mb-4">
          <a href="#" className="flex items-center gap-2 px-3 py-2 text-text-secondary hover:bg-bg-tertiary rounded-md">
        ...
        <div className="mb-2">
          ...
          <a href="#" className="flex items-center gap-2 px-3 py-2 text-text-primary bg-accent-orange/10 rounded-md">
            <div className="w-5 h-5 bg-accent-orange rounded flex items-center justify-center">
      ...
      <div className="p-2 border-t border-border">
        <a href="#" className="flex items-center gap-2 px-3 py-2 text-text-secondary hover:bg-bg-tertiary rounded-md text-sm">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
